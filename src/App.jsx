...
const DATA_AS_OF = "Wed, July 1, 2026 — R32 Day 4. 8 of 16 R32 matches complete. Canada, Paraguay, Brazil, Morocco, Norway, France, Mexico, England through to R16. Belgium vs Senegal & USA vs Bosnia still to play today.";
...
const MATCHES = [
  ...
  { id: 78, round: "R32", md: "R32", date: "Tue Jun 30", time: "1:00 PM", venue: "AT&T Stadium, Arlington", status: "final", home: "Ivory Coast", away: "Norway", hs: 1, as: 2, note: "Nusa 39' (NOR, Ødegaard assist), Diallo 74' equalizer (IVC, Pépé assist), Haaland 86' winner (NOR, Berg assist) — Norway's first-ever knockout stage win at a World Cup; Haaland delivers at the crucial moment. R16 vs Brazil, NY/NJ Jul 5." },
  { id: 77, round: "R32", md: "R32", date: "Tue Jun 30", time: "5:00 PM", venue: "MetLife Stadium, East Rutherford", status: "final", home: "France", away: "Sweden", hs: 3, as: 0, note: "Mbappé 45' (curling finish into far post), Barcola 53' (Olise throughball, top corner), Mbappé 74' (first-time curl off Olise pass). France dominant. Mbappé moves to 6 WC goals (tied with Messi for Golden Boot); also sets WC knockout stage record: 10 goals across 9 KO matches. R16 vs Paraguay, Philadelphia Jul 4." },
  { id: 79, round: "R32", md: "R32", date: "Tue Jun 30", time: "9:00 PM", venue: "Estadio Azteca, Mexico City", status: "final", home: "Mexico", away: "Ecuador", hs: 2, as: 0, note: "Quiñones 22' (cut inside, shot into top corner), Jiménez 31' (pounced on Ordóñez error). Mexico's first WC knockout win in 40 years — their famous 'quinto partido' curse is BROKEN. R16 vs England, Mexico City Jul 5." },
  { id: 80, round: "R32", md: "R32", date: "Wed Jul 1", time: "3:00 PM", venue: "Mercedes-Benz Stadium, Atlanta", status: "final", home: "England", away: "DR Congo", hs: 2, as: 1, note: "Cipenga 7' brilliant opener (DRC); Kane 75' header (Gordon cross), Kane ~83' right-foot shot (Gordon assist) — dramatic Kane brace from behind to seal comeback. Kane now England's all-time leading WC scorer (11 goals). R16 vs Mexico, Azteca Jul 5." },
...
const QUALIFICATION = [
  { team: "Mexico", flag: "🇲🇽", state: "in", detail: "R16 bound — beat Ecuador 2-0 in R32 (Quiñones 22', Jiménez 31', Azteca). Mexico's first WC knockout win in 40 years — the 'quinto partido' curse is BROKEN. R16 vs England, Mexico City Jul 5." },
  ...
  { team: "Brazil", flag: "🇧🇷", state: "in", detail: "R16 bound — beat Japan 2-1 in R32 (Martinelli 96' winner). Japan led early (Sano), Casemiro equalized, then Martinelli curled in a dramatic last-gasp winner. R16 vs Norway, NY/NJ Jul 5." },
  ...
  { team: "France", flag: "🇫🇷", state: "in", detail: "R16 bound — beat Sweden 3-0 in R32 (Mbappé 45', Barcola 53', Mbappé 74'). Dominant display; Mbappé at 6 WC goals (Golden Boot co-leader) and sets WC knockout record (10 KO-stage goals). R16 vs Paraguay, Philadelphia Jul 4." },
  { team: "Norway", flag: "🇳🇴", state: "in", detail: "R16 bound — beat Ivory Coast 2-1 in R32 (Nusa 39', Diallo 74' eq, Haaland 86' winner). Norway's first-ever knockout stage win at a World Cup. R16 vs Brazil, NY/NJ Jul 5." },
  ...
  { team: "England", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", state: "in", detail: "R16 bound — beat DR Congo 2-1 in R32 (Atlanta). Cipenga 7' put DRC ahead; Kane 75' header + 83' shot (both Gordon assists) sealed a dramatic comeback. Kane now England's all-time WC top scorer (11 goals). R16 vs Mexico, Azteca Jul 5." },
  ...
  { team: "Paraguay", flag: "🇵🇾", state: "in", detail: "R16 bound — SHOCKED Germany 4-3 on penalties in R32 (1-1 AET, Foxborough). Enciso 42', Havertz 54'. Goalkeeper Gill saved Havertz & Woltemade; Tah hit the bar. Paraguay declare national holiday. One of the greatest WC upsets ever. R16 vs France, Philadelphia Jul 4." },
  { team: "Ivory Coast", flag: "🇨🇮", state: "out", detail: "ELIMINATED — Lost to Norway 1-2 in R32 (Dallas). Nusa 39' gave Norway the lead; Diallo 74' equalized; Haaland 86' winner broke hearts. Ivory Coast exit despite a strong group stage campaign." },
  { team: "Sweden", flag: "🇸🇪", state: "out", detail: "ELIMINATED — Lost to France 0-3 in R32 (New York NJ). Mbappé brace (45', 74') and Barcola 53' — France completely dominant; Sweden had no answer." },
  ...
  { team: "DR Congo", flag: "🇨🇩", state: "out", detail: "ELIMINATED — Lost to England 1-2 in R32 (Atlanta). Cipenga gave DRC a stunning 7th-minute lead; Kane 75' header & 83' shot completed England's comeback. Historic achievement: DRC's first-ever WC knockout stage appearance." },
  ...
  { team: "Ecuador", flag: "🇪🇨", state: "out", detail: "ELIMINATED — Lost to Mexico 0-2 in R32 (Azteca). Quiñones 22' and Jiménez 31' in a dominant first half; Ordóñez error gifted the second. Mexico's co-host crowd made it feel like a final." },
...
const NOW_BRIEFING = {
  headline: "R32 Day 4 — 8 of 16 complete. Mexico end 40-year curse; Kane brace for England. Belgium & USA still to play TODAY.",
  body: "Eight Round of 32 matches are now done. Canada, Paraguay, Brazil, Morocco, Norway, France, Mexico, and England are all through to the Round of 16. The drama has been extraordinary: Paraguay eliminated Germany on penalties (first-ever WC shootout loss for Germany); Morocco eliminated Netherlands on penalties (3rd consecutive WC exit in shootout for the Dutch); Mexico ended their infamous 40-year knockout drought; and Kane dragged England past a stubborn DR Congo with two second-half goals. Today (Jul 1) still has Belgium vs Senegal (9 PM ET, Seattle) and USA vs Bosnia (not yet started). First R16 matches begin Saturday Jul 4.",
  threads: [
    "Canada 1-0 South Africa (Jun 28, LA): Eustáquio 90+4' volley — Canada's first WC knockout win. R16 vs Morocco, Houston Jul 4.",
    "Paraguay 1-1 Germany AET, PAR 4-3 pens (Jun 29, Boston): Enciso 42', Havertz 54'. Gill saves Havertz & Woltemade; Tah hits bar. GERMANY ELIMINATED — first-ever WC shootout loss. Paraguay declare national holiday. R16 vs France, Philadelphia Jul 4.",
    "Brazil 2-1 Japan (Jun 29, Houston): Sano (JPN), Casemiro eq, Martinelli 96' curler (BRA). R16 vs Norway, NY/NJ Jul 5.",
    "Morocco 1-1 Netherlands AET, MAR 3-2 pens (Jun 30, Monterrey): Gakpo 72', Diop 90+1'. Bounou saves Summerville; Saibari wins it. NETHERLANDS ELIMINATED — 3rd straight WC exit on pens. R16 vs Canada, Houston Jul 4.",
    "Norway 2-1 Ivory Coast (Jun 30, Dallas): Nusa 39', Diallo 74' eq, Haaland 86' winner — Norway's FIRST-EVER WC knockout stage win. R16 vs Brazil, NY/NJ Jul 5.",
    "France 3-0 Sweden (Jun 30, MetLife): Mbappé 45' & 74', Barcola 53'. Mbappé at 6 WC goals (Golden Boot co-leader with Messi); sets WC knockout stage record (10 goals). R16 vs Paraguay, Philadelphia Jul 4.",
    "Mexico 2-0 Ecuador (Jun 30, Azteca): Quiñones 22', Jiménez 31'. MEXICO'S FIRST WC KNOCKOUT WIN IN 40 YEARS — 'quinto partido' curse BROKEN at home. R16 vs England, Mexico City Jul 5.",
    "England 2-1 DR Congo (Jul 1, Atlanta): Cipenga 7' (DRC); Kane 75' header & 83' shot (both Gordon assists). KANE makes history: England's all-time WC top scorer (11 goals). R16 vs Mexico, Azteca Jul 5.",
    "TODAY (Jul 1): Belgium vs Senegal 9 PM ET, Seattle · USA vs Bosnia 6 PM ET, Bay Area (not yet known).",
    ...
    "R16 SCHEDULE: Jul 4 — Paraguay vs France (Philadelphia), Canada vs Morocco (Houston). Jul 5 — Brazil vs Norway (NY/NJ), Mexico vs England (Mexico City). Jul 6 — Spain/Austria vs Portugal/Croatia (Dallas), USA/Bosnia vs Belgium/Senegal (Seattle). Jul 7 — Argentina/Cabo Verde vs Australia/Egypt, Switzerland/Algeria vs Colombia/Ghana.",
  ],
};
...
const DAY_SUMMARIES = {
  ...
  "Tue Jun 30": "R32 Day 3 — four matches, all complete. Morocco 1-1 NED (AET, MAR 3-2 pens, Monterrey): Gakpo 72', Diop 90+1'. Norway 2-1 Ivory Coast (Dallas): Nusa 39', Diallo 74' eq, Haaland 86' winner — Norway's first WC KO win. France 3-0 Sweden (MetLife): Mbappé 45' & 74', Barcola 53' — Mbappé equals Messi's 6-goal Golden Boot tally. Mexico 2-0 Ecuador (Azteca): Quiñones 22', Jiménez 31' — Mexico's FIRST WC knockout win in 40 YEARS; the 'quinto partido' curse broken at the Azteca.",
  "Wed Jul 1": "R32 Day 4. England 2-1 DR Congo (Atlanta): Cipenga 7' stunning opener for DRC; Kane 75' & 83' (both Gordon assists) sealed England's comeback — Kane becomes England's all-time WC top scorer (11 goals). Belgium vs Senegal (Seattle) and USA vs Bosnia (Bay Area) TBD.",
